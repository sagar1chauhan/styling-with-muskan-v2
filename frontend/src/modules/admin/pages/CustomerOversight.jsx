...
export default function CustomerOversight() {
    const { getUserBookings } = useAdminAuth();
        ...
        (Array.isArray(bookings) ? bookings : []).forEach(b => {
            ...
            if (!customerMap.has(phone)) {
                customerMap.set(phone, {
                    id: phone,
                    name: b.customerName || "Unknown Customer",
                    phone: phone,
                    status: "active",
                    totalBookings: 0,
                    cancelledBookings: 0,
            ...
            // Mocking payment failures
            c.paymentFailures = Math.floor(c.totalBookings * 0.1);
        });

        // Add some dummy customers if empty
        if (customerMap.size === 0) {
            customerMap.set("9876543210", { id: "9876543210", name: "Riya Sharma", phone: "9876543210", status: "active", totalBookings: 12, cancelledBookings: 1, paymentFailures: 0 });
            customerMap.set("9876543211", { id: "9876543211", name: "Anjali Gupta", phone: "9876543211", status: "blocked", totalBookings: 4, cancelledBookings: 3, paymentFailures: 2 });
            customerMap.set("9876543212", { id: "9876543212", name: "Priya Singh", phone: "9876543212", status: "active", totalBookings: 1, cancelledBookings: 0, paymentFailures: 0 });
        }
