                    ...
                    <Card className="shadow-md border-slate-100 overflow-hidden">
                        ...
                        <CardContent className="p-6">
                            ...
                            <div className="flex items-end justify-between h-48 gap-2 pt-4">
                                {[
                                    { day: "Mon", value: 65, color: "bg-slate-200" },
                                    { day: "Tue", value: 85, color: "bg-slate-200" },
                                    { day: "Wed", value: 45, color: "bg-slate-200" },
                                    { day: "Thu", value: 95, color: "bg-purple-500" }, // Current Best
                                    { day: "Fri", value: 75, color: "bg-slate-200" },
                                    { day: "Sat", value: 90, color: "bg-slate-200" },
                                    { day: "Sun", value: 80, color: "bg-slate-200" },
                                ].map((item, idx) => (
                                    <div key={idx} className="flex-1 flex flex-col items-center gap-3 group">
                                        <div className="relative w-full flex flex-col justify-end h-full">
                                            ...
                                            <div
                                                className={`w-full rounded-t-lg transition-all duration-1000 ease-out hover:brightness-110 cursor-pointer ${item.color}`}
                                                style={{
                                                    height: `${item.value}%`,
                                                    animation: `growUp 1s ease-out forwards ${idx * 0.1}s`,
                                                    transform: 'scaleY(0)',
